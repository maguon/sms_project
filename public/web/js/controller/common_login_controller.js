app.controller("common_login_controller", ['$rootScope','$scope','$location','$q',"_basic","_host","_config",
            ...
            if($scope.mobile==''||$scope.password==''){
                ...
                _basic.post(_host.api_url+"/userLogin", {
                    ...
                    if(data.success==true){
                        ...
                        _basic.setSession(_basic.USER_TYPE,"10");
                        _basic.setHeader(_basic.USER_TYPE, "10");
                        _basic.setHeader(_basic.COMMON_AUTH_NAME, data.result.accessToken);
                        window.location.href="./common_home.html";
                    }else {
                        swal(data.msg,"","error");
                    }
